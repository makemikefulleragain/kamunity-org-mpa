...
Release gates: a deterministic GitHub CI candidate is prepared locally, but `main` remains unprotected and the currently published Netlify deploy has no traceable commit. Next: review and approve the Phoenix/MPA pushes, confirm both CI runs, publish an isolated MPA preview from the reviewed commit, then perform authenticated Phoenix publication, live edge/feed, contact/Kai, content and accessibility acceptance. Domain cutover still requires a separately approved rollback plan. The selected showcase includes VinoCode, Sovereignty Audit, AI Readiness and Org Health; remaining public copy/navigation still needs alignment with that decision and the GGA/Mycelium retirement.
